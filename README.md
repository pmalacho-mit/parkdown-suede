...
```bash
bash <(curl https://suede.sh/install-release) --repo pmalacho-mit/parkdown-suede
```
...
```bash
bash <(curl https://raw.githubusercontent.com/pmalacho-mit/suede/refs/heads/main/scripts/install-release.sh) --repo pmalacho-mit/parkdown-suede
```
